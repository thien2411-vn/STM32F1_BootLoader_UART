...
|--------------|---------------|------|-------------|
| **Bootloader** | 0x08000000 | 16KB | Bootloader code (0x4000 bytes) |
| **Application** | 0x08004400 | 47KB | Application firmware |

- **Bootloader Region**: `0x08000000 - 0x08003FFF` (16KB)
- **Application Region**: `0x08004400 - 0x0800FFFF` (47KB)
...
- **Maximum Firmware Size**: 48KB (47KB usable)
...
| **File size too large** | Application must be < 48KB |

## 📝 Version Information

- **Bootloader Version**: v1.0
- **Application Version**: v0.1
- **Maximum Application Size**: 48KB
